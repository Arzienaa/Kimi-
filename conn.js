...
{buttonId: `${prefix}owner`, buttonText: { displayText: '⋮☰ 𝗠𝗘𝗟𝗟𝗬' }, type: 1 },
...
const listMessage = {
  ...
  footer: '© created By Melly official',
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created By Melly official' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: 'Himiko MD', author: 'By Melly' }
